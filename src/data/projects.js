export const projectsData = [
  {
    ...
    features: [
      ...
      "Role-based access control for dentists, administrative staff, and patients.",
      "Interactive calendar for schedule management.",
      "Responsive design optimized for desktop and mobile devices."
    ],
    myRole: "Lead developer responsible for UI layout, API integration, state management, and user authentication flows."
  },
  {
    id: "banco-macro-ds",
    ...
    features: [
      ...
      "Full documentation and interactive testing sandbox in Storybook.",
      "Theme customization via Design Tokens and CSS variables.",
      "Accessibility compliance for financial products."
    ],
    myRole: "Built component architectures, documented usage guidelines in Storybook, and aligned design tokens with Figma specifications."
  },
  {
    id: "andina-art",
    ...
    features: [
      ...
      "Responsive layouts supporting tablet and mobile devices."
    ],
    myRole: "Frontend Engineer in charge of building the web application from scratch under tight production timelines."
  },
  {
    id: "bcycle-aventura",
    ...
    features: [
      "Station availability mapping and real-time updates.",
      "User membership management and trip tracking.",
      "Backend API integrations and database query optimization."
    ],
    myRole: "Full-Stack Engineer implementing new frontend features, mobile-friendly layouts, backend bug fixes, and ASP.NET services."
  }
];